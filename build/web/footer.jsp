<%-- 
    Document   : footer
    Created on : 12 janv. 2023, 22:34:53
    Author     : Princy
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                © <script>document.write(new Date().getFullYear())</script> Vente Enchere <span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by ETU1528-ETU1588-ETU1611-ETU1641</span>
                            </div>
                        </div>
                    </div>
                </footer>
